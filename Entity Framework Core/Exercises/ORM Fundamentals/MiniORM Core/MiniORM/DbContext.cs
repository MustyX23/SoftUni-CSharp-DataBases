...
namespace MiniORM
{
    public abstract class DbContext
    {
            ...
            where TEntity : class, new()
        {
            ...
            {
                var navigatonalPropertyName 
                    = foreignKey.GetCustomAttribute<ForeignKeyAttribute>().Name;

                var navigationProperty = entityType.GetProperty(navigatonalPropertyName);

                var navigationDbSet
                    = this.dbSetProperties[navigationProperty.PropertyType].GetValue(this);
